<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <router-link exact-active-class="active" :to="{name:'dashboard'}" class="menu-item">
            <a class="menu-link">
                <i class="menu-icon tf-icons bx bxs-dashboard"></i>
                <div>{{__('general.dashboard')}}</div>
            </a>
        </router-link>
        <!-- Apps & Pages -->
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">
                {{ __('general.manage_panel') }}
            </span></li>
        <router-link exact-active-class="active" :to="{name:'users'}" class="menu-item">
            <a class="menu-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div>{{ __('general.users_list') }}</div>
            </a>
        </router-link>
        <li class="menu-item">
