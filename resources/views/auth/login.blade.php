                ...
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <form id="formAuthentication" class="mb-3" action="" method="POST">
                        {{ csrf_field() }}
                        <div class="mb-3">
                            <label for="email" class="form-label">{{ __('general.username_or_email') }}</label>
                            <input type="text" class="form-control text-start" dir="ltr" id="email" name="username"
                                   value="{{ old('username') }}"
                                   placeholder="{{ __('general.username_or_email') }}" autofocus>
                        </div>
                        <div class="mb-3 form-password-toggle">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="#" data-bs-toggle="modal" data-bs-target="#resetPassword">
                                    <small>{{ __('general.forget_password') }}</small>
                                </a>
                            </div>
                    ...
                    <div class="modal-content p-3 p-md-5">
                        <div class="modal-body">
                            ...
                            <div class="text-center mb-4">
                                <h3 class="mb-4 secondary-font">{{ __('general.reset_password') }}</h3>
                            </div>
                            <h6> {!! __('general.reset_password_guide') !!} </h6>
                            <p>
